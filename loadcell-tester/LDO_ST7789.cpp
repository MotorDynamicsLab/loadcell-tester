...
*/
LDO_ST7789::LDO_ST7789(int8_t cs, int8_t dc, int8_t mosi,
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
LDO_ST7789::LDO_ST7789(int8_t cs, int8_t dc, int8_t rst) :
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
LDO_ST7789::LDO_ST7789(SPIClass *spiClass, int8_t cs, int8_t dc,
...
*/
/**************************************************************************/
void LDO_ST7789::init(uint16_t width, uint16_t height) {
  commonInit(NULL);
...
*/
/**************************************************************************/
void LDO_ST7789::setRotation(uint8_t m) {
  uint8_t madctl = 0;
